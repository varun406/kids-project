...
const CourseModal = () => {
    ...
    return ( <
        ...
        Wrapper >
        <
        CloseOutlined sx = { CancelIconStyle }
        onClick = {
            () => setCourseModalOpen((prev) => !prev) }
        /> {
            true ? ( <
                ...
                UpdatedDate >
                <
                Break > Updated: < /Break>{" "} { moment(courseModalData ? .updatedAt).format("MMMM,YYYY") } <
                /UpdatedDate> <
                ...
                < /Desc> <
                ButtonSection > {!courseAdded &&
                    (!cartAdded ? ( <
                        AddToCart onClick = {
                            () => addTocart(courseModalData) } >
                        Add to cart <
                        /AddToCart>
                    ) : ( <
                        Link to = "/cart" >
