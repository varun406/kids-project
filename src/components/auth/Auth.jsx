    ...
    return ( <
        ...
        CredentialDetails > {
            method === "signup" ? ( <
                ...
                InputField type = "text"
                placeholder = "7030XXXXXX" {...register("phone") }
                /> <
        ...
        /InputSection> <
        /CredentialDetails> <
        FormButton method = { method }
        type = "submit" > { method === "signup" ? (CheckAuthStatus.isLoading && !CheckAuthStatus.isAuthenticated) ? < Loader / > : "Sign up" : (CheckAuthStatus.isLoading && !CheckAuthStatus.isAuthenticated) ? < Loader / > : "Login" } <
        /FormButton> <
        NoticeSection >
        <
        Notice > {
